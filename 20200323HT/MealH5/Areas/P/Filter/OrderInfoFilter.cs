...
namespace MealH5.Areas.P.Filter
{
    ...
    /// 下单过程页面过滤器
    /// </summary>
    public class OrderInfoFilter : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            var orderInfo = Session[ConstantHelper.CURRENTPORDER] as P_Order;

            if (orderInfo == null || orderInfo.hospital == null)
            {
