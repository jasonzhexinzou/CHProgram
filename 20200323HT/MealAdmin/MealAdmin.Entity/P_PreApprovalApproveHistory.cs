...
{
    public class P_PreApprovalApproveHistory
    {
    ...
    public class P_PreApprovalApproveHistory_Time
    {
        public Guid ID { get; set; }
        public Guid PID { get; set; }
        public string UserName { get; set; }
    ...
    public class P_PreApprovalApproveHistory_View
    {
        public Guid ID { get; set; }
        public Guid PID { get; set; }
        public string UserName { get; set; }
    ...
    public class P_PreApprovalApproveHistory_Load
    {
        public Guid ID { get; set; }
        public Guid PID { get; set; }
        public string UserName { get; set; }
