...
namespace MealAdmin.Dao
{
    public interface IBaseDataDao
    {
        ...
        /// </summary>
        /// <returns></returns>
        List<P_PROVINCE> LoadProvinceByMarketList(string Type);
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        List<P_CITY> LoadCity(string Type);

        /// <summary>
        /// 获取全部城市
        /// </summary>
        /// <returns></returns>
        List<P_CITY> LoadCityByHos(string Type);
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        List<P_CITY> LoadCityByMarketList(string Type);
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        int SyncBaseData(List<P_PROVINCE> listProvince, List<P_CITY> listCity, List<P_HOSPITAL> listHospital);
        #endregion
        ...
        /// <param name="market"></param>
        /// <returns></returns>
        int AddProvince(string name, string pinyin,string market);
        #endregion
        ...
        /// <returns></returns>
        int AddProvince(List<P_PROVINCE> listProvince);
        #endregion
        ...
        /// <param name="pinyin"></param>
        /// <returns></returns>
        int AddCity(int provinceId, string name, string pinyin,string market);
        #endregion
        ...
        /// <returns></returns>
        int AddCity(List<P_CITY> listCity);
        #endregion
